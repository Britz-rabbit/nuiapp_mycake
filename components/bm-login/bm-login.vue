        ...
        <view class="otherLoginWays" v-if="mConfigs.otherLoginWays" v-show="hideFooter">
            ...
            <view class="icons">
                <slot name="otherLoginWays_icons">
					<image src="../../static/img/icon_QQ.png" mode="" class="tubiao" @click="$emit('qqLogin')"></image>
					<image src="../../static/img/icon_weixin.png" mode="" class="tubiao"  @click="$emit('weixinLogin')"></image>
					<image src="../../static/img/icon_weibo.png" mode="" class="tubiao"  @click="$emit('weiboLogin')"></image>
                </slot>
            </view>
        </view>
        ...
        .auto_quickLogin{
            ...
            .autoLogin_wrapper{
                .autoLogin{
                    ...
                    width: 12px;
                    height: 12px;
					background-image:url('../../static/img/unchosen.png');
                ...
                input[type="checkbox"]:checked + .autoLogin{
                    background-image: url("../../static/img/chosen.png");
                }
                span{
                    margin-left: .2rem;
                }
