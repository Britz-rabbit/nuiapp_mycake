        ...
        <view class="otherLoginWays" v-if="mConfigs.otherLoginWays" v-show="hideFooter">
            ...
            <view class="icons">
                <slot name="otherLoginWays_icons">
					<image src="../../static/img/icon_QQ.png" mode="" @click="$emit('qqLogin')"></image>
					<image src="../../static/img/icon_weixin.png" mode="" @click="$emit('weixinLogin')"></image>
					<image src="../../static/img/icon_weibo.png" mode="" @click="$emit('weiboLogin')"></image>
                </slot>
            </view>
        </view>
